/* Generated trust store: ISRG Root X1 (Let's Encrypt root, RSA-4096).
 * Self-signed root; DER from https://letsencrypt.org/certs/isrgrootx1.pem
 * Used by BASIC HTTPGET$ to anchor Let's Encrypt server chains. */
static const unsigned char tiku_basic_root_isrgx1[] = {
