 ...
 *
 * tiku_desk_conduct.h - the conductor channel: driving a desktop from
 * outside it.
 *
 ...
 */
#ifndef TIKU_DESK_CONDUCT_H_
#define TIKU_DESK_CONDUCT_H_
...
#define TIKU_DESK_CONDUCT_VERSION 1
#define TIKU_DESK_CONDUCT_ARG     64
#define TIKU_DESK_CONDUCT_TEXT    512
...
#define TIKU_DESK_CONDUCT_ANSWER_MS 4000

/* Driver to shell. */
#define TIKU_DESK_CMSG_HELLO   1u   /* u32 version                        */
#define TIKU_DESK_CMSG_INJECT  2u   /* tiku_desk_event_t                  */
#define TIKU_DESK_CMSG_QUERY   3u   /* u32 what, i32 a, i32 b, arg[64]    */
/* Shell to driver. */
#define TIKU_DESK_CMSG_ANSWER  16u  /* i32 ok, i32 num, text[512]         */

/** @brief What a QUERY asks for. */
#define TIKU_DESK_CQ_PIXEL     1u   /* a, b are x, y; the answer is num   */
#define TIKU_DESK_CQ_TEXT      2u   /* arg names it; the answer is text   */
 ...
 */
typedef int (*tiku_desk_conduct_text_fn)(void *ctx, const char *name,
                                         char *out, size_t max);

/** @brief What the shell reads a pixel with. */
typedef unsigned (*tiku_desk_conduct_pixel_fn)(void *ctx, int x, int y);

/** @brief Where the shell delivers an injected event. */
typedef void (*tiku_desk_conduct_inject_fn)(void *ctx,
 ...
 */
int tiku_desk_conduct_listen(tiku_desk_conduct_t *c, const char *path,
 ...
 */
int tiku_desk_conduct_poll(tiku_desk_conduct_t *c);
...
int tiku_desk_conduct_inject(tiku_desk_conduct_client_t *c,
                             const tiku_desk_event_t *event);
 ...
 */
int tiku_desk_conduct_query(tiku_desk_conduct_client_t *c, uint32_t what,
                            int a, int b, const char *arg,
                            int *num, char *text, size_t max);

#endif /* TIKU_DESK_CONDUCT_H_ */
