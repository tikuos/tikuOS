 ...
 *
 * tiku_desk_msg.h - a message that describes itself.
 *
 ...
 */
#ifndef TIKU_DESK_MSG_H_
#define TIKU_DESK_MSG_H_
...
typedef struct tiku_desk_msg tiku_desk_msg_t;
...
tiku_desk_msg_t *tiku_desk_msg_new(uint32_t what);

/** @brief Give back everything @p m holds, nested messages included. */
void tiku_desk_msg_free(tiku_desk_msg_t *m);

/** @brief Empty it of fields, keeping the code and the room. */
void tiku_desk_msg_clear(tiku_desk_msg_t *m);

/** @brief A message with the same code and the same fields.  NULL on fail. */
tiku_desk_msg_t *tiku_desk_msg_copy(const tiku_desk_msg_t *m);

uint32_t tiku_desk_msg_what(const tiku_desk_msg_t *m);
void tiku_desk_msg_set_what(tiku_desk_msg_t *m, uint32_t what);
...
int tiku_desk_msg_add_bool(tiku_desk_msg_t *m, const char *name, int v);
int tiku_desk_msg_add_int8(tiku_desk_msg_t *m, const char *name, int8_t v);
int tiku_desk_msg_add_int16(tiku_desk_msg_t *m, const char *name, int16_t v);
int tiku_desk_msg_add_int32(tiku_desk_msg_t *m, const char *name, int32_t v);
int tiku_desk_msg_add_int64(tiku_desk_msg_t *m, const char *name, int64_t v);
int tiku_desk_msg_add_float(tiku_desk_msg_t *m, const char *name, float v);
int tiku_desk_msg_add_double(tiku_desk_msg_t *m, const char *name, double v);
int tiku_desk_msg_add_string(tiku_desk_msg_t *m, const char *name,
                             const char *v);
int tiku_desk_msg_add_blob(tiku_desk_msg_t *m, const char *name,
                           const void *bytes, size_t len);
int tiku_desk_msg_add_point(tiku_desk_msg_t *m, const char *name,
                            float x, float y);
int tiku_desk_msg_add_rect(tiku_desk_msg_t *m, const char *name,
                           tiku_msg_rect_t r);
int tiku_desk_msg_add_ref(tiku_desk_msg_t *m, const char *name,
                          const char *path);
 ...
 */
int tiku_desk_msg_add_message(tiku_desk_msg_t *m, const char *name,
...
int tiku_desk_msg_find_bool(const tiku_desk_msg_t *m, const char *name,
                            int index, int *out);
int tiku_desk_msg_find_int8(const tiku_desk_msg_t *m, const char *name,
                            int index, int8_t *out);
int tiku_desk_msg_find_int16(const tiku_desk_msg_t *m, const char *name,
                             int index, int16_t *out);
int tiku_desk_msg_find_int32(const tiku_desk_msg_t *m, const char *name,
                             int index, int32_t *out);
int tiku_desk_msg_find_int64(const tiku_desk_msg_t *m, const char *name,
                             int index, int64_t *out);
int tiku_desk_msg_find_float(const tiku_desk_msg_t *m, const char *name,
                             int index, float *out);
int tiku_desk_msg_find_double(const tiku_desk_msg_t *m, const char *name,
                              int index, double *out);
int tiku_desk_msg_find_point(const tiku_desk_msg_t *m, const char *name,
                             int index, float *x, float *y);
int tiku_desk_msg_find_rect(const tiku_desk_msg_t *m, const char *name,
 ...
 */
const char *tiku_desk_msg_find_string(const tiku_desk_msg_t *m,
                                      const char *name, int index);

/** @brief The path under @p name, or NULL.  As above: not copied. */
const char *tiku_desk_msg_find_ref(const tiku_desk_msg_t *m,
                                   const char *name, int index);
 ...
 */
const void *tiku_desk_msg_find_blob(const tiku_desk_msg_t *m,
                                    const char *name, int index,
                                    size_t *len);
 ...
 */
tiku_desk_msg_t *tiku_desk_msg_find_message(const tiku_desk_msg_t *m,
                                            const char *name, int index);
...
int tiku_desk_msg_field_count(const tiku_desk_msg_t *m);
 ...
 */
const char *tiku_desk_msg_field_at(const tiku_desk_msg_t *m, int i,
                                   tiku_msg_type_t *type, int *count);

/** @brief How many values @p name has (0 when it is not there at all). */
int tiku_desk_msg_count(const tiku_desk_msg_t *m, const char *name);

/** @brief Whether @p name is there, and of @p type.  0 for either no. */
int tiku_desk_msg_has(const tiku_desk_msg_t *m, const char *name,
                      tiku_msg_type_t type);

/** @brief Take @p name out altogether.  @return 1 when there was one. */
int tiku_desk_msg_remove(tiku_desk_msg_t *m, const char *name);

/** @brief What a type is called, for a log or a failing test to say. */
const char *tiku_desk_msg_type_name(tiku_msg_type_t type);
...
size_t tiku_desk_msg_flat_size(const tiku_desk_msg_t *m);
 ...
 */
int tiku_desk_msg_flatten(const tiku_desk_msg_t *m, void *buf, size_t max,
                          size_t *wrote);
 ...
 */
tiku_desk_msg_t *tiku_desk_msg_unflatten(const void *buf, size_t len,
                                         size_t *read);

#endif /* TIKU_DESK_MSG_H_ */
