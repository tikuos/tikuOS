 ...
 *
 * tiku_desk_msg.c - a message that describes itself.
 *
...
tiku_desk_msg_t *
tiku_desk_msg_new(uint32_t what)
{
    tiku_desk_msg_t *m = (tiku_desk_msg_t *)calloc(1u, sizeof *m);
...
void
tiku_desk_msg_clear(tiku_desk_msg_t *m)
{
    int i;
...
void
tiku_desk_msg_free(tiku_desk_msg_t *m)
{
    if (m == NULL) {
        return;
    }
    tiku_desk_msg_clear(m);
    free(m->field);
    free(m);
}

uint32_t
tiku_desk_msg_what(const tiku_desk_msg_t *m)
{
    return (m != NULL) ? m->what : 0u;
}

void
tiku_desk_msg_set_what(tiku_desk_msg_t *m, uint32_t what)
{
    if (m != NULL) {
        m->what = what;
    }
 ...
 */
static field_t *
field_find(const tiku_desk_msg_t *m, const char *name)
{
    int i;
 ...
 */
static field_t *
field_add(tiku_desk_msg_t *m, const char *name, size_t n,
          tiku_msg_type_t type)
{
    field_t *f;
    char *copy;
 ...
 */
static int
put(tiku_desk_msg_t *m, const char *name, tiku_msg_type_t type,
...
static const val_t *
value_of(const tiku_desk_msg_t *m, const char *name, int index,
         tiku_msg_type_t type)
{
...
int
tiku_desk_msg_add_bool(tiku_desk_msg_t *m, const char *name, int v)
{
...
int
tiku_desk_msg_add_int8(tiku_desk_msg_t *m, const char *name, int8_t v)
{
...
int
tiku_desk_msg_add_int16(tiku_desk_msg_t *m, const char *name, int16_t v)
{
    unsigned char b[2];
...
int
tiku_desk_msg_add_int32(tiku_desk_msg_t *m, const char *name, int32_t v)
{
    unsigned char b[4];
...
int
tiku_desk_msg_add_int64(tiku_desk_msg_t *m, const char *name, int64_t v)
{
    unsigned char b[8];
...
int
tiku_desk_msg_add_float(tiku_desk_msg_t *m, const char *name, float v)
{
    unsigned char b[4];
...
int
tiku_desk_msg_add_double(tiku_desk_msg_t *m, const char *name, double v)
{
    unsigned char b[8];
    uint64_t bits;
...
int
tiku_desk_msg_add_string(tiku_desk_msg_t *m, const char *name, const char *v)
{
    if (v == NULL) {
        return 0;
    }
...
int
tiku_desk_msg_add_ref(tiku_desk_msg_t *m, const char *name, const char *path)
{
    if (path == NULL) {
        return 0;
    }
...
int
tiku_desk_msg_add_blob(tiku_desk_msg_t *m, const char *name,
...
int
tiku_desk_msg_add_point(tiku_desk_msg_t *m, const char *name,
                        float x, float y)
{
    unsigned char b[8];
...
int
tiku_desk_msg_add_rect(tiku_desk_msg_t *m, const char *name,
                       tiku_msg_rect_t r)
{
    unsigned char b[16];
...
int
tiku_desk_msg_add_message(tiku_desk_msg_t *m, const char *name,
                          const tiku_desk_msg_t *sub)
{
    size_t n;
    unsigned char *flat;
    int ok;
    ...
    ok = tiku_desk_msg_flatten(sub, flat, n, NULL) &&
...
int
tiku_desk_msg_find_bool(const tiku_desk_msg_t *m, const char *name,
                        int index, int *out)
{
...
int
tiku_desk_msg_find_int8(const tiku_desk_msg_t *m, const char *name,
...
int
tiku_desk_msg_find_int16(const tiku_desk_msg_t *m, const char *name,
...
int
tiku_desk_msg_find_int32(const tiku_desk_msg_t *m, const char *name,
...
int
tiku_desk_msg_find_int64(const tiku_desk_msg_t *m, const char *name,
...
int
tiku_desk_msg_find_float(const tiku_desk_msg_t *m, const char *name,
                         int index, float *out)
{
...
int
tiku_desk_msg_find_double(const tiku_desk_msg_t *m, const char *name,
...
int
tiku_desk_msg_find_point(const tiku_desk_msg_t *m, const char *name,
...
int
tiku_desk_msg_find_rect(const tiku_desk_msg_t *m, const char *name,
 ...
 */
static const char *
text_of(const tiku_desk_msg_t *m, const char *name, int index,
        tiku_msg_type_t type)
{
...
const char *
tiku_desk_msg_find_string(const tiku_desk_msg_t *m, const char *name,
                          int index)
{
...
const char *
tiku_desk_msg_find_ref(const tiku_desk_msg_t *m, const char *name, int index)
{
    return text_of(m, name, index, TIKU_MSG_T_REF);
}

const void *
tiku_desk_msg_find_blob(const tiku_desk_msg_t *m, const char *name,
...
tiku_desk_msg_t *
tiku_desk_msg_find_message(const tiku_desk_msg_t *m, const char *name,
                           int index)
{
    ...
    return tiku_desk_msg_unflatten(v->data, v->len, NULL);
}
...
int
tiku_desk_msg_field_count(const tiku_desk_msg_t *m)
{
    return (m != NULL) ? m->nfield : 0;
}

const char *
tiku_desk_msg_field_at(const tiku_desk_msg_t *m, int i,
...
int
tiku_desk_msg_count(const tiku_desk_msg_t *m, const char *name)
{
    const field_t *f = field_find(m, name);
...
int
tiku_desk_msg_has(const tiku_desk_msg_t *m, const char *name,
                  tiku_msg_type_t type)
{
    const field_t *f = field_find(m, name);
...
int
tiku_desk_msg_remove(tiku_desk_msg_t *m, const char *name)
{
...
const char *
tiku_desk_msg_type_name(tiku_msg_type_t type)
{
    switch (type) {
...
size_t
tiku_desk_msg_flat_size(const tiku_desk_msg_t *m)
{
...
int
tiku_desk_msg_flatten(const tiku_desk_msg_t *m, void *buf, size_t max,
                      size_t *wrote)
{
    size_t need = tiku_desk_msg_flat_size(m);
...
tiku_desk_msg_t *
tiku_desk_msg_unflatten(const void *buf, size_t len, size_t *read)
{
 ...
 */
tiku_desk_msg_t *
tiku_desk_msg_copy(const tiku_desk_msg_t *m)
{
    ...
    out = tiku_desk_msg_flatten(m, flat, n, NULL)
              ? tiku_desk_msg_unflatten(flat, n, NULL) : NULL;
    free(flat);
    return out;
}
