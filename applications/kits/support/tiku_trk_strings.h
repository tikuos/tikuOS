 ...
 *
 * tiku_trk_strings.h - the words the interface is made of.
 *
 ...
 */
#ifndef TIKU_TRK_STRINGS_H_
#define TIKU_TRK_STRINGS_H_
 ...
 */
const char *tiku_trk_str(const char *key);
