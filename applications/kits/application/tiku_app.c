 ...
 *
 * tiku_app.c - embedded application lifecycle and registry.
 *
...
int
tiku_app_registry_add(tiku_app_registry_t *registry,
...
const tiku_app_descriptor_t *
tiku_app_registry_find(const tiku_app_registry_t *registry,
                            const char *id)
{
    int i;
...
int
tiku_app_registry_count(const tiku_app_registry_t *registry)
{
    return (registry != NULL) ? registry->count : 0;
}

const tiku_app_descriptor_t *
tiku_app_registry_at(const tiku_app_registry_t *registry, int index)
{
...
int
tiku_app_instance_start(tiku_app_instance_t *instance,
                             const tiku_app_descriptor_t *descriptor,
...
int
tiku_app_run(const tiku_app_descriptor_t *descriptor,
                  int argc, char **argv)
{
...
void
tiku_app_instance_tick(tiku_app_instance_t *instance,
                            int64_t now_us)
{
...
void
tiku_app_instance_stop(tiku_app_instance_t *instance)
{
    if (instance == NULL || !instance->running) {
        return;
    }
