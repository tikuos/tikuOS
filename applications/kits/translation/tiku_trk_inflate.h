 ...
 *
 * tiku_trk_inflate.h - DEFLATE decompression (RFC 1951).
 *
 ...
 */
#ifndef TIKU_TRK_INFLATE_H_
#define TIKU_TRK_INFLATE_H_
 ...
 */
long tiku_trk_inflate(const unsigned char *src, long slen,
 ...
 * not worth that.
 */
long tiku_trk_inflate_zlib(const unsigned char *src, long slen,
                           unsigned char *out, long omax);

#endif /* TIKU_TRK_INFLATE_H_ */
