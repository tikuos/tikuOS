 ...
 *
 * tiku_trk_jpeg.h - baseline JPEG decoding.
 *
 ...
 */
#ifndef TIKU_TRK_JPEG_H_
#define TIKU_TRK_JPEG_H_
 ...
 */
int tiku_trk_jpeg_decode(const unsigned char *src, long n, int *w, int *h,
                         uint32_t **out);

#endif /* TIKU_TRK_JPEG_H_ */
