 ...
 *
 * The WDT register layout is identical on Apollo510 and Apollo4 Lite, so the
 * on/off/pause/resume/kick logic here mirrors tiku_cpu_watchdog_apollo4l.c
 * apart from the CMSIS header pulled in.
 *
